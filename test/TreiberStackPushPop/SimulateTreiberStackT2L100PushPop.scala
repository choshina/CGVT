...
class SimulateTreiberStackT2L100PushPop(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = TreiberStack 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateTreiberStackT2L100PushPop(logName, verbose) 
