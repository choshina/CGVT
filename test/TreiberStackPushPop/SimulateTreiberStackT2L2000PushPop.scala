...
class SimulateTreiberStackT2L2000PushPop(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = TreiberStack 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateTreiberStackT2L2000PushPop(logName, verbose) 
