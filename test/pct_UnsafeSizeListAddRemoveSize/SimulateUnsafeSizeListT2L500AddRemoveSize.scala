...
class SimulateUnsafeSizeListT2L500AddRemoveSize(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = UnsafeSizeList 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateUnsafeSizeListT2L500AddRemoveSize(logName, verbose) 
