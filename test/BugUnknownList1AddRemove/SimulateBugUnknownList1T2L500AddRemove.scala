...
class SimulateBugUnknownList1T2L500AddRemove(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = BugUnknownList1 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateBugUnknownList1T2L500AddRemove(logName, verbose) 
