...
class SimulateBugUnknownList3T2L100AddRemove(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateBugUnknownList3T2L100AddRemove(logName, verbose) 
