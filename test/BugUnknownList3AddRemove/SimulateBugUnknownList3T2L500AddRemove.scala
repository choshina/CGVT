...
class SimulateBugUnknownList3T2L500AddRemove(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = BugUnknownList3 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateBugUnknownList3T2L500AddRemove(logName, verbose) 
