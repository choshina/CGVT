...
class SimulateLFTreiberStackT2L10000PushPop(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = LFTreiberStack 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateLFTreiberStackT2L10000PushPop(logName, verbose) 
