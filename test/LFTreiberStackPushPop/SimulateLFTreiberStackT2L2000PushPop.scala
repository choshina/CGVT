...
class SimulateLFTreiberStackT2L2000PushPop(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateLFTreiberStackT2L2000PushPop(logName, verbose) 
