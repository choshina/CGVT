...
package test.LFTreiberStackPushPop ; 
...
class VTLFTreiberStackTest { 
  private LFTreiberStack data ; 
  VTLFTreiberStackTest () { 
    this.data = new LFTreiberStack() ; 
  } 
...
class TestThread extends Thread { 
  private VTLFTreiberStackTest data ; 
  private int elemBase ; 
  private TraceRecord[] trace ; 

  TestThread (String name, VTLFTreiberStackTest q, TraceRecord[] tr) { 
    super(name) ; 
    this.data = q ; 
    this.elemBase = 0 ; 
     this.trace = tr ; 
...
class TestingLFTreiberStackT2L10000PushPop { 
  public static void main(String argv[]) { 
    int tdNum = 2, mdNum = 2, trLen = 10000; 
    VTLFTreiberStackTest testObj = new VTLFTreiberStackTest() ; 
    ...
    try { 
      ...
      out.write("2 10000 LFTreiberStack push pop\n") ; 
      for (int i=0; i < tdNum; i++) { 
        out.write("Thread " + i + "\n") ; 
