...
class VTBugUnknownList4Test { 
  private BugUnknownList4 data ; 
  VTBugUnknownList4Test () { 
    this.data = new BugUnknownList4() ; 
  } 
...
class TestThread extends Thread { 
  private VTBugUnknownList4Test data ; 
  private int elemBase ; 
  private TraceRecord[] trace ; 
	private int threadID;
	private Controller controller;

  TestThread (String name, VTBugUnknownList4Test q, TraceRecord[] tr, int tid,Controller c) { 
    super(name) ; 
    this.data = q ; 
    this.elemBase = 0 ; 
     this.trace = tr ; 
...
class TestingBugUnknownList4T2L500AddRemove { 
  public static void main(String argv[]) { 
    int tdNum = 2, mdNum = 2, trLen = 500; 
    VTBugUnknownList4Test testObj = new VTBugUnknownList4Test() ; 
