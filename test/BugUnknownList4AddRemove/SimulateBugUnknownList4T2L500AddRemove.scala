...
class SimulateBugUnknownList4T2L500AddRemove(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = BugUnknownList4 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateBugUnknownList4T2L500AddRemove(logName, verbose) 
