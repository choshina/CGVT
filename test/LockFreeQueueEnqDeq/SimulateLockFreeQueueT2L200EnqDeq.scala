...
class SimulateLockFreeQueueT2L200EnqDeq(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateLockFreeQueueT2L200EnqDeq(logName, verbose) 
