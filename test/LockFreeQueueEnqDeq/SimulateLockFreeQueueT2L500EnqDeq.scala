...
class SimulateLockFreeQueueT2L500EnqDeq(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = LockFreeQueue 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateLockFreeQueueT2L500EnqDeq(logName, verbose) 
