...
class SimulateBugUnknownList2T2L100AddRemove(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateBugUnknownList2T2L100AddRemove(logName, verbose) 
