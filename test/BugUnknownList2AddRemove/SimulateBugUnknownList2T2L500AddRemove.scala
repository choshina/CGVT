...
class SimulateBugUnknownList2T2L500AddRemove(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = BugUnknownList2 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateBugUnknownList2T2L500AddRemove(logName, verbose) 
