...
class SimulateLockFreeListT2L500AddRemove(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateLockFreeListT2L500AddRemove(logName, verbose) 
