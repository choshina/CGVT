...
class SimulateKStackT2L500PushPop(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = KStack 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateKStackT2L500PushPop(logName, verbose) 
