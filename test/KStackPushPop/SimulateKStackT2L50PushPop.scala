...
class SimulateKStackT2L50PushPop(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = KStack 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateKStackT2L50PushPop(logName, verbose) 
