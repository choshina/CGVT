...
class SimulateSimpleListT2L1000AddRemove(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = SimpleList 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateSimpleListT2L1000AddRemove(logName, verbose) 
