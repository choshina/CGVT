...
class SimulateOptimisticLinkedQueueT2L500OfferPoll(logName: String, verbose: Boolean) extends Simulation(logName, verbose) { 
  type T = OptimisticLinkedQueue 
...
object Simulate { 
  ...
  val simu : Simulation = new SimulateOptimisticLinkedQueueT2L500OfferPoll(logName, verbose) 
