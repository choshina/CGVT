...
public class RerunTraceOptimisticLinkedQueue13015{
	public static void main(String[] argv){
		...
		testobj.vtMethod0(26);
		testobj.vtMethod1();
		tr[0] = new TraceRecord[25];
		tr[1] = new TraceRecord[28];
		...
		try{
			FileWriter fw = new FileWriter("tracelog/loc_OptimisticLinkedQueue_13015.temp.testlog");
...
class TestThread0 extends Thread{
	...
	public void run(){
		...
		args = new LinkedList<ArgType>();
		poll_ret = data.vtMethod1();
		trace[24] = new TraceRecord(args,poll_ret,1,false);
	}
}
...
class TestThread1 extends Thread{
	...
	public void run(){
		...
		args = new LinkedList<ArgType>();
		poll_ret = data.vtMethod1();
		trace[16] = new TraceRecord(args,poll_ret,1,false);
		args = new LinkedList<ArgType>();
		poll_ret = data.vtMethod1();
		trace[17] = new TraceRecord(args,poll_ret,1,false);
		args = new LinkedList<ArgType>();
		...
		args = new LinkedList<ArgType>();
		poll_ret = data.vtMethod1();
		trace[23] = new TraceRecord(args,poll_ret,1,false);
		args = new LinkedList<ArgType>();
		offer_1 = 41;
		args.add(new ArgInt(offer_1));
		data.vtMethod0(offer_1);
