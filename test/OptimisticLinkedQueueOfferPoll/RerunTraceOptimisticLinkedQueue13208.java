...
public class RerunTraceOptimisticLinkedQueue13208{
	public static void main(String[] argv){
		...
		testobj.vtMethod0(96);
		testobj.vtMethod0(12);
		tr[0] = new TraceRecord[12];
		tr[1] = new TraceRecord[14];
		...
		try{
			FileWriter fw = new FileWriter("tracelog/loc_OptimisticLinkedQueue_13208.temp.testlog");
...
class TestThread0 extends Thread{
	...
	public void run(){
		...
		args = new LinkedList<ArgType>();
		poll_ret = data.vtMethod1();
		trace[11] = new TraceRecord(args,poll_ret,1,false);
	}
}
