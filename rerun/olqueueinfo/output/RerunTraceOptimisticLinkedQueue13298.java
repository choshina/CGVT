...
public class RerunTraceOptimisticLinkedQueue13298{
	public static void main(String[] argv){
		...
		try{
			FileWriter fw = new FileWriter("tracelog/loc_OptimisticLinkedQueue_13298.temp.testlog");
